...
tar -czf - Dockerfile compose.yaml package.json bun.lock tsconfig.json src scripts/backup.sh scripts/copy-migrations.ts signal-forge.example.json .dockerignore |
